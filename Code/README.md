...
This directory contains Wazuh configuration files and a reference of actual commands used during the SIEM homelab project.
...
└── commands-used.md       # Actual commands executed during project
```
...
This project demonstrates **hands-on command-line proficiency** rather than automation scripting. All attack simulations, agent deployments, and system modifications were performed using manual command execution and industry-standard tools.
...
- [Troubleshooting Log](../TROUBLESHOOTING_LOG.md) - Build process and issues resolved
- [Attack Scenarios](../ATTACK_SCENARIOS.md) - Detailed attack simulation documentation
- [Commands Used](commands-used.md) - Full command reference
